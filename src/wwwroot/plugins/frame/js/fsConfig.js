...
layui.define([], function (exports) {
	...
	fsConfig["global"] = {
		...
		"uploadHtmlUrl" : "upload/index", //上传附件html地址，默认/plugins/frame/views/upload.html
	    ...
	    "dataName" : "results", //非表格数据的字段名称，默认：results.data
		},
		"page" : { //分页配置
			...
			"response": {//响应配置
				"countName": "results.total", //数据总数的字段名称，默认：results.data.total
				"dataName" : "results", //数据列表的字段名称，默认：results.data
				"dataNamePage": "results.list" //分页数据列表的字段名称，默认：results.data.list
			}//,
