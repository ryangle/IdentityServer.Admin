...
layui.define(['element',"fsConfig","fsCommon"], function(exports){
	...
	var menuConfig = {
		...
		loadUrl : "", //加载数据地址
		rootMenuId : "root", //根目录菜单id
		defaultSelectTopMenuId : "console", //默认选中头部菜单id
		defaultSelectLeftMenuId : "index", //默认选中左边菜单id
		...
		data : [
			{ "menuId": "console", "menuName":"控制台", "menuIcon":"fa-cog", "menuHref":"", "parentMenuId":"root"},
            { "menuId": "menu", "menuName": "主菜单", "menuIcon": "fa-table", "menuHref": "", "parentMenuId":"console"},
            { "menuId": "index", "menuName": "首页", "menuIcon": "&#xe68e;", "menuHref": "/signalr/index", "parentMenuId": "menu" },
            { "menuId": "product", "menuName": "产品列表", "menuIcon": "fa-list", "menuHref": "/product/index", "parentMenuId": "menu" },
            { "menuId": "historicaldatasetting", "menuName": "历史数据服务配置", "menuIcon": "fa-list", "menuHref": "/historicaldatasetting/index", "parentMenuId": "menu" },
            { "menuId": "historicaldatasymbolsetting", "menuName": "历史数据产品配置", "menuIcon": "fa-list", "menuHref": "/historicaldatasymbolsetting/index", "parentMenuId": "menu" },
            { "menuId": "dataprovider", "menuName": "数据源管理", "menuIcon": "fa-list", "menuHref": "/dataprovider/index", "parentMenuId": "menu" },
            { "menuId": "closeopensettle", "menuName": "开盘/收盘时间", "menuIcon": "fa-list", "menuHref": "/closeopensettle/index", "parentMenuId": "menu" },
            { "menuId": "journal", "menuName": "日志管理", "menuIcon": "fa-list", "menuHref": "/journal/index", "parentMenuId": "menu" }
